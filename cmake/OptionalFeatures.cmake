...
option(ENABLE_H264 			"Enable H.264" 								ON)
option(ENABLE_H265 			"Enable H.265" 								ON)
...
if (ENABLE_X264)
	...
	target_compile_definitions(Alchemy PRIVATE ENABLE_H264)
else()
	message(STATUS "Disabled x264")
endif()
if (ENABLE_H265)
	message(STATUS "Enabled x265")
	target_compile_definitions(Alchemy PRIVATE ENABLE_H265)
else()

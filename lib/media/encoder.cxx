...
const std::list<Alchemist::Media::Encoder::Type> Alchemist::Media::Encoder::Base::Available = {
	// Video
	#ifdef ENABLE_LIBAOM
	AV1_LIBAOM,
	#endif
...
const std::list<Alchemist::Media::Info> Alchemist::Media::Encoder::Base::All = {
	// Video
	...
	{AAC_FRAUNHOFFER,		"libfdk_aac",		"Fraunhoffer AAC encoder"	},

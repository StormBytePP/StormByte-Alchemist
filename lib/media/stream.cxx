...
Stream::Stream(std::unique_ptr<Codec>&& codec):m_default(false), m_forced(false), m_codec(std::move(codec)) {}
...
const std::unique_ptr<Codec>& Stream::GetCodec() const noexcept { return m_codec; }
...
const std::list<Alchemist::Media::Decoder::Type> Alchemist::Media::Decoder::Base::Available = {
	// Video
	AV1_DEFAULT,
	#ifdef ENABLE_DAV1D
	AV1_DAV1D,
...
const std::list<Alchemist::Media::Info> Alchemist::Media::Decoder::Base::All = {
	// Video

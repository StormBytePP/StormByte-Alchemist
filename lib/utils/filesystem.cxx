...
bool Utils::Filesystem::is_folder_readable(const std::filesystem::path& fullpath, bool use_cerr) {
...
bool Utils::Filesystem::is_folder_readable_and_writable(const std::filesystem::path& fullpath, bool use_cerr) {
